...
export function Footer() {
  return (
    <footer className="bg-secondary/50 dark:bg-secondary/30 pt-16 pb-8 border-t border-border">
      <div className="container">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5">
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="mt-4 text-sm text-muted-foreground max-w-sm">
              Creating innovative solutions for the digital world. We transform ideas into high-performance software and applications.
            </p>
            <div className="flex mt-4 space-x-4">
              ...
              <a href="https://www.linkedin.com/company/zelabria/" className="text-muted-foreground hover:text-primary">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <Link to="/services/web-development" className="text-sm text-muted-foreground hover:text-primary">
                  Web Development
                </Link>
              </li>
              <li>
                <Link to="/services/mobile-apps" className="text-sm text-muted-foreground hover:text-primary">
                  Mobile Apps
                </Link>
              </li>
              <li>
                <Link to="/services/data-science" className="text-sm text-muted-foreground hover:text-primary">
                  Data Science
                </Link>
              </li>
              <li>
                <Link to="/services/cloud-services" className="text-sm text-muted-foreground hover:text-primary">
                  Cloud Services
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              ...
              <li className="flex items-center">
                ...
                <a href="mailto:contact.zelabria@gmail.com" className="text-sm text-muted-foreground hover:text-primary">
        ...
        <div className="mt-12 border-t border-border pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Zelabria. All rights reserved.
          </p>
